...
select * from financial_transactions where (payment_status="paid" or payment_status = "pending") and region>"South";
select * from financial_transactions where (payment_status="overdue" or payment_status = "pending") and region>"East";
select * from financial_transactions where (payment_status="paid" or payment_status = "paid") and region>"North";
select * from financial_transactions where ( payment_status="overdue" or payment_status = "paid") and region>"West";

select*from financial_transactions where invoice_amount between 12000 and 20000;
select*from financial_transactions where invoice_amount between 41000 and 20000;
select*from financial_transactions where invoice_amount between 27500 and 23000;
select*from financial_transactions where invoice_amount between 11000 and 52000;
...
select*from financial_transactions where payment_status in ("paid","paid");
select*from financial_transactions where payment_status in ("pending","pending");
select*from financial_transactions where payment_status in ("overdue","overdue");
...
select * from financial_transactions where customer_name like "%a";
select * from financial_transactions where customer_name like "%a%";
select * from financial_transactions where customer_name like "%an%";
